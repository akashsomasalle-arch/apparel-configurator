...
`;continue}if((u=l.match(i))&&(c.gamma=parseFloat(u[1])),(u=l.match(a))&&(c.exposure=parseFloat(u[1])),(u=l.match(o))&&(c.valid|=2,c.format=u[1]),(u=l.match(s))&&(c.valid|=4,c.height=parseInt(u[1],10),c.width=parseInt(u[2],10)),c.valid&2&&c.valid&4)break}return c.valid&2||t(3,`missing format specifier`),c.valid&4||t(3,`missing image size specifier`),c},i=function(e,n,r){let i=n;if(i<8||i>32767||e[0]!==2||e[1]!==2||e[2]&128)return new Uint8Array(e);i!==(e[2]<<8|e[3])&&t(3,`wrong scanline width`);let a=new Uint8Array(4*n*r);a.length||t(4,`unable to allocate buffer space`);let o=0,s=0,c=4*i,l=new Uint8Array(4),u=new Uint8Array(c),d=r;for(;d>0&&s<e.byteLength;){s+4>e.byteLength&&t(1),l[0]=e[s++],l[1]=e[s++],l[2]=e[s++],l[3]=e[s++],(l[0]!=2||l[1]!=2||(l[2]<<8|l[3])!=i)&&t(3,`bad rgbe scanline format`);let n=0,r;for(;n<c&&s<e.byteLength;){r=e[s++];let i=r>128;if(i&&(r-=128),(r===0||n+r>c)&&t(3,`bad scanline data`),i){let t=e[s++];for(let e=0;e<r;e++)u[n++]=t}else u.set(e.subarray(s,s+r),n),n+=r,s+=r}let f=i;for(let e=0;e<f;e++){let t=0;a[o]=u[e+t],t+=i,a[o+1]=u[e+t],t+=i,a[o+2]=u[e+t],t+=i,a[o+3]=u[e+t],o+=4}d--}return a},a=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=e[t+0]*i,n[r+1]=e[t+1]*i,n[r+2]=e[t+2]*i,n[r+3]=1},o=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=Fr.toHalfFloat(Math.min(e[t+0]*i,65504)),n[r+1]=Fr.toHalfFloat(Math.min(e[t+1]*i,65504)),n[r+2]=Fr.toHalfFloat(Math.min(e[t+2]*i,65504)),n[r+3]=Fr.toHalfFloat(1)},s=new Uint8Array(e);s.pos=0;let c=r(s),l=c.width,u=c.height,d=i(s.subarray(s.pos),l,u),f,p,m;switch(this.type){case Re:m=d.length/4;let e=new Float32Array(m*4);for(let t=0;t<m;t++)a(d,t*4,e,t*4);f=e,p=Re;break;case ze:m=d.length/4;let t=new Uint16Array(m*4);for(let e=0;e<m;e++)o(d,e*4,t,e*4);f=t,p=ze;break;default:throw Error(`THREE.HDRLoader: Unsupported type: `+this.type)}return{width:l,height:u,data:f,header:c.string,gamma:c.gamma,exposure:c.exposure,type:p}}setDataType(e){return this.type=e,this}load(e,t,n,r){function i(e,n){switch(e.type){case Re:case ze:e.colorSpace=Gt,e.minFilter=H,e.magFilter=H,e.generateMipmaps=!1,e.flipY=!0;break}t&&t(e,n)}return super.load(e,i,n,r)}}}));function Yd(){this._document.hidden===!1&&this.reset()}var Xd,Zd=e((()=>{Xd=class{constructor(){this._previousTime=0,this._currentTime=0,this._startTime=performance.now(),this._delta=0,this._elapsed=0,this._timescale=1,this._document=null,this._pageVisibilityHandler=null}connect(e){this._document=e,e.hidden!==void 0&&(this._pageVisibilityHandler=Yd.bind(this),e.addEventListener(`visibilitychange`,this._pageVisibilityHandler,!1))}disconnect(){this._pageVisibilityHandler!==null&&(this._document.removeEventListener(`visibilitychange`,this._pageVisibilityHandler),this._pageVisibilityHandler=null),this._document=null}getDelta(){return this._delta/1e3}getElapsed(){return this._elapsed/1e3}getTimescale(){return this._timescale}setTimescale(e){return this._timescale=e,this}reset(){return this._currentTime=performance.now()-this._startTime,this}dispose(){this.disconnect()}update(e){return this._pageVisibilityHandler!==null&&this._document.hidden===!0?this._delta=0:(this._previousTime=this._currentTime,this._currentTime=(e===void 0?performance.now():e)-this._startTime,this._delta=(this._currentTime-this._previousTime)*this._timescale,this._elapsed+=this._delta),this}}}));t((async()=>{_u(),Vu(),Kd(),Jd(),Zd();var e;try{let t=await fetch(`./config.json`);if(!t.ok)throw Error(`HTTP ${t.status}`);e=await t.json()}catch(e){console.error(`[Boot] Failed to load config.json:`,e);let t=document.getElementById(`loaderLabel`),n=document.getElementById(`loaderBar`);throw t&&(t.textContent=`Error: Could not load configuration.`),n&&(n.style.background=`#ff4343`),e}var t=e.model.parts,n=e.ui.colorPalette,r=e.ui.sections,i=e.ui.assetLimit,a=e.graphics.canvasSize,o=e.graphics.logoSizeRatio,s=e.graphics.textFontSize,c=e.graphics.textCanvasHeight,l=e.graphics.textDefaultFont,u=e.graphics.textDefaultColor;(function(){t.forEach(t=>{t===`all`||t===`inside`||(e.camera.views[t]||console.warn(`[Config] No camera view defined for part: "${t}"`),e.model.defaultColors[t]||console.warn(`[Config] No default color defined for part: "${t}"`))}),e.scene.environmentPath||console.warn(`[Config] Missing scene.environmentPath`),e.model.path||console.warn(`[Config] Missing model.path`)})();var d={};for(let[t,n]of Object.entries(e.camera.views))d[t]=new K(n.x,n.y,n.z);var f={};t.forEach(t=>{let n=e.userConfiguration?.partColors?.[t]?.color,r=e.userConfiguration?.partColors?.[t]?.colorName,i=e.model?.defaultColors?.[t]||`#FFFFFF`;f[t]={color:n||i,colorName:r||`Default`}});var p=t.find(e=>e!==`all`&&e!==`inside`),m=e.scene.backgroundColor,h=null,g=e.camera?.defaultView||p,_=null,v=[],y=-1,b=[],x={},S={},C={},w={},T={},E={},D={};function O(e){e.img&&=(e.img.src=``,null)}var k=!1,A=0,ee=0,te=!1,j=0,M=0,N=0,P=!1,ne=0,re=0,ie=document.getElementById(`panelProperties`),ae=document.getElementById(`propWidth`),oe=document.getElementById(`propHeight`),se=document.getElementById(`propX`),ce=document.getElementById(`propY`),F=document.getElementById(`propRotate`),le=document.getElementById(`propScale`),ue=document.getElementById(`layersList`),I={colorHex:document.getElementById(`colorHex`),colorPicker:document.getElementById(`base-color-picker`),summaryColor:document.getElementById(`summaryColor`),summaryPart:document.getElementById(`summaryPart`),sceneColorPicker:document.getElementById(`scene-color-picker`),sceneColorHex:document.getElementById(`sceneColorHex`),insideColorPicker:document.getElementById(`inside-color-picker`),insideColorHex:document.getElementById(`insideColorHex`),uvCanvas:document.getElementById(`uvCanvas`),logoOpacityVal:document.getElementById(`logoOpacityVal`),logoControls:document.getElementById(`logoControls`),textOnlyControls:document.getElementById(`textOnlyControls`),propertiesEmptyState:document.getElementById(`propertiesEmptyState`),swatchGrid:document.getElementById(`swatchGrid`),assetGrid:document.getElementById(`assetGrid`),assetCountLabel:document.getElementById(`assetCountLabel`),uvMinimapContainer:document.getElementById(`uvMinimapContainer`)},L=document.querySelector(`canvas.webgl`),de=new ar,fe=new Qo,pe=new G,me=document.createElement(`canvas`);me.width=512,me.height=512;var he=me.getContext(`2d`),ge=new Ta(me);ge.colorSpace=Wt,de.background=ge;function _e(t){e&&e.scene&&(e.scene.backgroundColor=t);let n=new X(t),r=n.clone().multiplyScalar(.35),i=me.width/2,a=me.height/2,o=Math.max(i,a)*1.5,s=he.createRadialGradient(i,a,0,i,a,o);s.addColorStop(0,n.getStyle()),s.addColorStop(1,r.getStyle()),he.fillStyle=s,he.fillRect(0,0,me.width,me.height),ge.needsUpdate=!0,I.sceneColorPicker&&(I.sceneColorPicker.value=t),I.sceneColorHex&&(I.sceneColorHex.tagName===`INPUT`?I.sceneColorHex.value=t.toUpperCase():I.sceneColorHex.textContent=t.toUpperCase()),I.uvCanvas&&(I.uvCanvas.style.backgroundColor=t),typeof z==`function`&&z()}document.getElementById(`scene-color-picker`)?.addEventListener(`input`,e=>_e(e.target.value)),document.getElementById(`sceneColorHex`)?.addEventListener(`input`,e=>{/^#[0-9A-F]{6}$/i.test(e.target.value)&&_e(e.target.value)});function ve(e){Te.color.set(e),I.insideColorPicker&&(I.insideColorPicker.value=e),I.insideColorHex&&(I.insideColorHex.tagName===`INPUT`?I.insideColorHex.value=e.toUpperCase():I.insideColorHex.textContent=e.toUpperCase()),typeof z==`function`&&z()}document.getElementById(`inside-color-picker`)?.addEventListener(`input`,e=>ve(e.target.value)),document.getElementById(`insideColorHex`)?.addEventListener(`input`,e=>{/^#[0-9A-F]{6}$/i.test(e.target.value)&&ve(e.target.value)});var ye={width:window.innerWidth,height:window.innerHeight},be=new wo(45,ye.width/ye.height,.1,100);be.position.z=8,de.add(be);var R=new Bu(be,L);R.enableDamping=!0,R.dampingFactor=.05,R.minDistance=6,R.maxDistance=10,R.minPolarAngle=1,R.maxPolarAngle=2,R.enablePan=!0;var xe=new gu({canvas:L,antialias:!0,powerPreference:`high-performance`});xe.setSize(ye.width,ye.height),xe.setPixelRatio(Math.min(window.devicePixelRatio,2)),xe.toneMapping=2,xe.toneMappingExposure=e.scene.exposure,xe.colorSpace=Wt;var Se=xe.capabilities.getMaxAnisotropy(),Ce=!1;function z(){Ce||(Ce=!0,requestAnimationFrame(()=>{xe.render(de,be),Ce=!1}))}_e(e.scene.backgroundColor),window.addEventListener(`resize`,()=>{ye.width=window.innerWidth,ye.height=window.innerHeight,be.aspect=ye.width/ye.height,be.updateProjectionMatrix(),xe.setSize(ye.width,ye.height),xe.setPixelRatio(Math.min(window.devicePixelRatio,2)),z()});var we=new jo(16777215,.7);we.position.set(2,4,2),de.add(we);var B=new jo(16777215,.3);B.position.set(-2,2,2),de.add(B);var V=new jo(16777215,.4);V.position.set(0,2,-3),de.add(V),new qd().load(e.scene.environmentPath,t=>{t.mapping=303,de.environment=t,de.environmentIntensity=e.scene.environmentIntensity,z()});var Te=new Ia({color:`#FFFFFF`,metalness:0,roughness:1,side:1});t.forEach(e=>{if(e===`inside`)return;T[e]=new Ia({color:f[e].color,metalness:0,roughness:1,side:0});let t=document.createElement(`canvas`);t.width=a,t.height=a;let n=t.getContext(`2d`);n.imageSmoothingEnabled=!0,n.imageSmoothingQuality=`high`;let r=new Ta(t);r.flipY=!1,r.format=Ke,r.type=Me,r.colorSpace=Wt,r.minFilter=je,r.magFilter=H,r.generateMipmaps=!0,r.anisotropy=Se,x[e]=t,S[e]=n,C[e]=r,w[e]=new Ia({map:r,transparent:!0,roughness:1,metalness:0,envMapIntensity:.2,alphaTest:.05,polygonOffset:!0,polygonOffsetFactor:-4,polygonOffsetUnits:-4,depthWrite:!1,side:0})}),new od().load(e.model.path,e=>{for(let n of[...e.scene.children])if(n.isMesh){n.castShadow=!1,n.receiveShadow=!1;let e=p,r=n.name.toLowerCase().replace(/[-_ ]/g,``);for(let n of t)if(n!==`all`&&r.includes(n.replace(/[-_ ]/g,``))){e=n;break}n.material=T[e],n.userData.partName=e,b.push(n),de.add(n);let i=n.clone();i.material=Te,i.renderOrder=0,de.add(i);let a=n.clone();a.material=w[e],a.renderOrder=1,de.add(a);let o=n.clone();o.material=w.all,o.renderOrder=2,de.add(o)}b.forEach(e=>{if(e.name.toLowerCase().includes(`stitch`))return;let t=e.userData.partName,n=e.geometry.attributes.uv,r=e.geometry.index;if(!n)return;let i=1/0,o=-1/0,s=1/0,c=-1/0;for(let e=0;e<n.count;e++){let t=n.getX(e),r=n.getY(e);t<i&&(i=t),t>o&&(o=t),r<s&&(s=r),r>c&&(c=r)}D[t]={minU:i,maxU:o,minV:s,maxV:c};let l=document.createElement(`canvas`);l.width=a,l.height=a;let u=l.getContext(`2d`);u.fillStyle=`#000000`,u.strokeStyle=`#000000`,u.lineWidth=1.5,u.lineJoin=`round`;let d=(e,t,r)=>{u.beginPath(),u.moveTo(n.getX(e)*a,n.getY(e)*a),u.lineTo(n.getX(t)*a,n.getY(t)*a),u.lineTo(n.getX(r)*a,n.getY(r)*a),u.closePath(),u.fill(),u.stroke()};if(r)for(let e=0;e<r.count;e+=3)d(r.getX(e),r.getX(e+1),r.getX(e+2));else for(let e=0;e<n.count;e+=3)d(e,e+1,e+2);E[t]=l}),Je=!0,U(),cn()});var Ee=72/2,De=18,Oe=`#1cc4fa`,ke=`#ff4343`;function Ae(e){let t=e.w/2,n=e.h/2;return{pin:{lx:-t,ly:-n},rotate:{lx:t,ly:-n},del:{lx:-t,ly:n},clone:{lx:0,ly:n},resize:{lx:t,ly:n}}}function Ne(e,t,n){let r=e.x+e.w/2,i=e.y+e.h/2,a=Math.cos(-e.angle),o=Math.sin(-e.angle);return{lx:a*(t-r)-o*(n-i),ly:o*(t-r)+a*(n-i)}}function Pe(e,t,n,r){let{lx:i,ly:a}=Ne(e,t,n),o=Ae(e)[r];return Math.abs(i-o.lx)<=Ee&&Math.abs(a-o.ly)<=Ee}function Fe(e,t,n){let{lx:r,ly:i}=Ne(e,t,n);return Math.abs(r)<=e.w/2&&Math.abs(i)<=e.h/2}function Ie(e,t,n=Oe){_.beginPath(),_.arc(e,t,De,0,Math.PI*2),_.fillStyle=n,_.fill(),_.lineWidth=2,_.strokeStyle=`#ffffff`,_.stroke()}function Le(e,t){Ie(e,t,ke),_.beginPath(),_.moveTo(e-8,t-8),_.lineTo(e+8,t+8),_.moveTo(e+8,t-8),_.lineTo(e-8,t+8),_.lineWidth=2.5,_.strokeStyle=`#ffffff`,_.stroke()}function Re(e,t){Ie(e,t,Oe),_.lineCap=`round`,_.lineJoin=`round`,_.lineWidth=2.5,_.strokeStyle=`#ffffff`,_.beginPath(),_.arc(e,t,7,Math.PI*.25,-Math.PI*.25,!1),_.stroke(),_.beginPath(),_.moveTo(e-.5,t-5.5),_.lineTo(e+5,t-5),_.lineTo(e+4.5,t-10.5),_.stroke(),_.lineCap=`butt`,_.lineJoin=`miter`}function ze(e,t){Ie(e,t,Oe),_.lineWidth=2.5,_.strokeStyle=`#ffffff`,_.strokeRect(e-7,t-3,10,10),_.strokeRect(e-3,t-7,10,10)}function Be(e,t){Ie(e,t,Oe),_.lineCap=`round`,_.lineJoin=`round`,_.lineWidth=2.5,_.strokeStyle=`#ffffff`,_.beginPath();let n=6.5;_.moveTo(e-n,t-n),_.lineTo(e+n,t+n),_.moveTo(e-n+4.5,t-n),_.lineTo(e-n,t-n),_.lineTo(e-n,t-n+4.5),_.moveTo(e+n-4.5,t+n),_.lineTo(e+n,t+n),_.lineTo(e+n,t+n-4.5),_.stroke(),_.lineCap=`butt`,_.lineJoin=`miter`}function Ve(e,t,n){Ie(e,t,n?`#222222`:`#aaaaaa`),_.fillStyle=`#ffffff`,_.fillRect(e-7,t-1,14,10),_.fillStyle=n?`#222222`:`#aaaaaa`,_.beginPath(),_.arc(e,t+3.5,2,0,Math.PI*2),_.moveTo(e-2.5,t+7.5),_.lineTo(e+2.5,t+7.5),_.lineTo(e,t+2),_.fill(),_.beginPath(),_.strokeStyle=`#ffffff`,_.lineWidth=2.5,n?_.arc(e,t-1,4.5,Math.PI,0):(_.arc(e,t-4,4.5,Math.PI,0),_.moveTo(e-4.5,t-4),_.lineTo(e-4.5,t-1)),_.stroke()}function U(){t.forEach(e=>{S[e]&&S[e].clearRect(0,0,a,a)}),v.forEach((e,t)=>{if(_=S[e.part],!_)return;_.save();let n=e.x+e.w/2,r=e.y+e.h/2;if(_.translate(n,r),_.rotate(e.angle),_.globalAlpha=(e.opacity??100)/100,_.globalCompositeOperation=e.blend??`source-over`,_.drawImage(e.img,-e.w/2,-e.h/2,e.w,e.h),_.globalAlpha=1,_.globalCompositeOperation=`source-over`,t===y){_.strokeStyle=e.pinned?`#888888`:Oe,_.lineWidth=1.5,_.setLineDash(e.pinned?[6,4]:[]),_.strokeRect(-e.w/2,-e.h/2,e.w,e.h),_.setLineDash([]);let t=e.w/2,n=e.h/2;Ve(-t,-n,e.pinned),e.pinned||(Re(t,-n),Le(-t,n),ze(0,n),Be(t,n))}_.restore()}),t.forEach(e=>{C[e]&&(C[e].needsUpdate=!0)}),xt(),Xe(),St(),z()}var He={scale:1,offsetX:0,offsetY:0},Ue=document.createElement(`canvas`);Ue.width=a,Ue.height=a;var We=Ue.getContext(`2d`),Ge=document.createElement(`canvas`);Ge.width=a,Ge.height=a;var qe=Ge.getContext(`2d`),Je=!0,W={minU:0,maxU:1,minV:0,maxV:1,isValid:!1};function Ye(){We.clearRect(0,0,a,a);let e=g===`all`?b:b.filter(e=>e.userData.partName===g),t=1/0,n=-1/0,r=1/0,i=-1/0,o=!1;e.forEach(e=>{if(e.name.toLowerCase().includes(`stitch`))return;let s=e.userData.partName,c=D[s];c&&(o=!0,c.minU<t&&(t=c.minU),c.maxU>n&&(n=c.maxU),c.minV<r&&(r=c.minV),c.maxV>i&&(i=c.maxV));let l=E[s];if(l){let e=f[s]?.color||`#ffffff`;qe.clearRect(0,0,a,a),qe.drawImage(l,0,0),qe.globalCompositeOperation=`source-in`,qe.fillStyle=e,qe.fillRect(0,0,a,a),qe.globalCompositeOperation=`source-over`,We.drawImage(Ge,0,0)}}),W={minU:t,maxU:n,minV:r,maxV:i,isValid:o},Je=!1}function Xe(){let e=document.getElementById(`uvMinimapContainer`),n=document.getElementById(`uvCanvas`);if(!e||!n||e.classList.contains(`minimized`))return;e.style.display=`block`;let r=n.getContext(`2d`),i=n.width,a=n.height;if(r.clearRect(0,0,i,a),Je&&Ye(),!W.isValid)return;r.save();let o=(W.maxU-W.minU)*i,s=(W.maxV-W.minV)*a,c=(W.minU+W.maxU)/2*i,l=(W.minV+W.maxV)/2*a,u=o===0||s===0?1:Math.min((i-40)/o,(a-40)/s);He.scale=u,He.offsetX=i/2-c*u,He.offsetY=a/2-l*u,r.translate(i/2,a/2),r.scale(u,u),r.translate(-c,-l),r.drawImage(Ue,0,0,i,a),g===`all`?t.forEach(e=>{x[e]&&r.drawImage(x[e],0,0,i,a)}):(x[g]&&r.drawImage(x[g],0,0,i,a),x.all&&r.drawImage(x.all,0,0,i,a)),r.restore()}var Ze=null,Qe=!1;function $e(e,t,n){Qe||(Qe=!0,requestAnimationFrame(()=>{Ze=et(e,t),n(Ze),Qe=!1}))}function et(e,t){let n=L.getBoundingClientRect();pe.set((e-n.left)/n.width*2-1,-((t-n.top)/n.height)*2+1),fe.setFromCamera(pe,be);let r=fe.intersectObjects(b,!0);return r.length>0&&r[0].uv?{x:r[0].uv.x*a,y:r[0].uv.y*a,part:r[0].object.userData.partName}:null}function tt(e,t){let n=document.getElementById(`uvCanvas`);if(!n)return null;let r=n.getBoundingClientRect(),i=(e-r.left)/r.width*n.width,o=(t-r.top)/r.height*n.height,s=(i-He.offsetX)/He.scale,c=(o-He.offsetY)/He.scale,l=a/n.width;return{x:s*l,y:c*l,part:g}}function nt(e){if(y>=0){let t=v[y];if(e.part===`all`||t.part===e.part||t.part===`all`){if(Pe(t,e.x,e.y,`pin`)){t.pinned=!t.pinned,U();return}if(!t.pinned){if(Pe(t,e.x,e.y,`del`)){O(v[y]),v.splice(y,1),y=-1,R.enabled=!0,U();return}if(Pe(t,e.x,e.y,`clone`)){v.push({...t,x:t.x+30,y:t.y+30}),y=v.length-1,U();return}if(Pe(t,e.x,e.y,`rotate`)){P=!0,ne=t.angle,re=Math.atan2(e.y-(t.y+t.h/2),e.x-(t.x+t.w/2)),R.enabled=!1;return}if(Pe(t,e.x,e.y,`resize`)){te=!0,j=Math.hypot(e.x-(t.x+t.w/2),e.y-(t.y+t.h/2)),M=t.w,N=t.h,R.enabled=!1;return}}}}for(let t=v.length-1;t>=0;t--)if((e.part===`all`||v[t].part===e.part||v[t].part===`all`)&&Fe(v[t],e.x,e.y)){y=t,v[t].part!==g&&ct(v[t].part),v[t].type===`text`?lt(`text`):lt(`upload`),v[t].pinned||(k=!0,A=e.x-v[t].x,ee=e.y-v[t].y,R.enabled=!1),U();return}y!==-1&&(y=-1,U())}function rt(e){if(!k&&!te&&!P||!e||y<0)return;let t=v[y];if(e.part===`all`||t.part===e.part||t.part===`all`){if(k&&(t.x=e.x-A,t.y=e.y-ee),te){let n=Math.hypot(e.x-(t.x+t.w/2),e.y-(t.y+t.h/2))/j;t.w=Math.max(30,M*n),t.h=Math.max(30,N*n)}if(P){let n=Math.atan2(e.y-(t.y+t.h/2),e.x-(t.x+t.w/2));t.angle=ne+(n-re)}U()}}function it(){k=te=P=!1,R.enabled=!0}L.addEventListener(`mousedown`,e=>{let t=et(e.clientX,e.clientY);t?nt(t):y!==-1&&(y=-1,U())}),L.addEventListener(`mousemove`,e=>{!k&&!te&&!P||$e(e.clientX,e.clientY,e=>{e&&rt(e)})}),L.addEventListener(`mouseup`,e=>{it(),et(e.clientX,e.clientY)&&U()});var at=document.getElementById(`uvCanvas`);at&&(at.addEventListener(`mousedown`,e=>nt(tt(e.clientX,e.clientY))),at.addEventListener(`mousemove`,e=>rt(tt(e.clientX,e.clientY))),at.addEventListener(`mouseup`,it),at.addEventListener(`mouseleave`,it)),window.addEventListener(`keydown`,e=>{if(!(e.target.tagName===`INPUT`||e.target.tagName===`TEXTAREA`||e.target.tagName===`SELECT`)){if(e.key===`Escape`){y=-1,U();return}(e.key===`Delete`||e.key===`Backspace`)&&y>=0&&!v[y]?.pinned&&(v.splice(y,1),y=-1,U())}});function ot(e){let t=d[e]||d[p];be.position.copy(t),R.target.set(0,0,0),R.update(),R.autoRotate&&(R.autoRotate=!1,document.getElementById(`auto-rotate-toggle`)?.classList.remove(`active`))}function st(e){return e.replace(/-/g,` `).replace(/\b\w/g,e=>e.toUpperCase())}function ct(e){g=e,document.querySelectorAll(`.comp-btn`).forEach(t=>t.classList.toggle(`active`,t.dataset.part===e));let t=st(e);document.querySelectorAll(`.active-part-name`).forEach(n=>{n.tagName===`SELECT`?n.value=e:n.textContent=t}),document.querySelectorAll(`.dropdown-item`).forEach(t=>{t.classList.toggle(`active`,t.dataset.part===e)}),I.summaryPart&&(I.summaryPart.textContent=t),f[e]&&ft(f[e].color,!1,e!==`all`),ot(e),Je=!0,Xe()}document.querySelectorAll(`.custom-dropdown`).forEach(e=>{let n=e.querySelector(`.dropdown-trigger`),r=e.querySelector(`.active-part-name`),i=e.querySelector(`.dropdown-list`);i.innerHTML=``,t.filter(e=>e!==`all`&&e!==`inside`).forEach(e=>{let t=document.createElement(`li`);t.className=`dropdown-item ${e===g?`active`:``}`,t.dataset.part=e,t.textContent=st(e),i.appendChild(t)});let a=e.querySelectorAll(`.dropdown-item`);n.addEventListener(`click`,t=>{t.stopPropagation(),document.querySelectorAll(`.custom-dropdown.is-open`).forEach(t=>{t!==e&&t.classList.remove(`is-open`)}),e.classList.toggle(`is-open`)}),a.forEach(t=>{t.addEventListener(`click`,()=>{r.textContent=t.textContent,a.forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`),e.classList.remove(`is-open`),ct(t.dataset.part)})})}),document.addEventListener(`click`,()=>{document.querySelectorAll(`.custom-dropdown.is-open`).forEach(e=>{e.classList.remove(`is-open`)})});function lt(e){document.getElementById(`panelProperties`),document.getElementById(`uvMinimapContainer`),document.querySelectorAll(`.nav-item[data-section]`).forEach(t=>t.classList.toggle(`active`,t.dataset.section===e)),r.forEach(t=>{let n=document.getElementById(`section${t.charAt(0).toUpperCase()+t.slice(1)}`);n&&n.classList.toggle(`hidden`,t!==e)});let t=document.getElementById(`componentSelector`);t&&(t.style.display=e===`color`||e===`upload`||e===`text`?`flex`:`none`);let n=!1;if(e===`color`||e===`saved`||e===`ai`)n=!0;else if(y>=0&&v[y]){let t=v[y].type===`text`;e===`upload`&&t&&(n=!0),e===`text`&&!t&&(n=!0)}n&&(y=-1,U()),setTimeout(()=>{St()},350)}document.querySelectorAll(`.nav-item[data-section]`).forEach(e=>e.addEventListener(`click`,()=>lt(e.dataset.section))),document.getElementById(`toggleRight`)?.addEventListener(`click`,()=>{document.getElementById(`panelRight`).classList.toggle(`collapsed`)}),document.getElementById(`auto-rotate-toggle`)?.addEventListener(`click`,e=>{R.autoRotate=!R.autoRotate,e.currentTarget.classList.toggle(`active`,R.autoRotate)}),document.getElementById(`resetCameraBtn`)?.addEventListener(`click`,()=>ot(`front`));var ut=document.getElementById(`viewFront`),dt=document.getElementById(`viewBack`);ut?.addEventListener(`click`,()=>{ut.classList.add(`view-btn--active`),dt?.classList.remove(`view-btn--active`),ot(`front`)}),dt?.addEventListener(`click`,()=>{dt.classList.add(`view-btn--active`),ut?.classList.remove(`view-btn--active`),ot(`back`)});function ft(e,r=!0,i=!0){i&&(g===`all`?Object.values(T).forEach(t=>t.color.set(e)):T[g]&&T[g].color.set(e)),I.colorHex&&(I.colorHex.tagName===`INPUT`?I.colorHex.value=e.toUpperCase():I.colorHex.textContent=e.toUpperCase()),I.colorPicker&&(I.colorPicker.value=e);let a=n.find(t=>t.hex.toUpperCase()===e.toUpperCase())?.name??`Custom Color`;I.summaryColor&&(I.summaryColor.textContent=a),r&&(g===`all`?t.filter(e=>e!==`inside`).forEach(t=>{f[t].color=e,f[t].colorName=a}):(f[g].color=e,f[g].colorName=a)),Je=!0,Xe(),z()}var pt=null;n.forEach((e,t)=>{let n=document.createElement(`div`);n.className=`swatch`+(t===0?` active`:``),n.style.background=e.hex,n.setAttribute(`title`,e.name),t===0&&(pt=n,ft(e.hex)),n.addEventListener(`click`,()=>{pt?.classList.remove(`active`),n.classList.add(`active`),pt=n,ft(e.hex)}),I.swatchGrid?.appendChild(n)}),document.getElementById(`base-color-picker`)?.addEventListener(`input`,e=>{pt?.classList.remove(`active`),ft(e.target.value)}),document.getElementById(`colorHex`)?.addEventListener(`input`,e=>{/^#[0-9A-F]{6}$/i.test(e.target.value)&&(pt?.classList.remove(`active`),ft(e.target.value))});function mt(e){let t=b.find(t=>t.userData.partName===e);if(!t)return{x:a/2,y:a/2};t.geometry.computeBoundingBox();let n=new K;t.geometry.boundingBox.getCenter(n),t.localToWorld(n);let r=d[e]||d[p],i=new Qo;i.set(r,new K().subVectors(n,r).normalize());let o=i.intersectObject(t,!1);return o.length>0&&o[0].uv?{x:o[0].uv.x*a,y:o[0].uv.y*a}:{x:a/2,y:a/2}}function ht(e,t){let n=new Image;n.onload=()=>{let r=mt(t===`all`?p:t),i=a*o,s=n.naturalHeight/n.naturalWidth*i;v.push({img:n,srcUrl:e,x:r.x-i/2,y:r.y-s/2,w:i,h:s,origW:i,origH:s,angle:0,pinned:!1,opacity:100,blend:`source-over`,part:t}),y=v.length-1,U()},n.src=e}function gt(e){let t=document.createElement(`canvas`),n=t.getContext(`2d`);n.font=`bold ${s}px ${e.font}`,t.width=n.measureText(e.text).width+20,t.height=c,n.font=`bold ${s}px ${e.font}`,n.fillStyle=e.color,n.textBaseline=`middle`,n.fillText(e.text,10,70);let r=t.toDataURL();e.srcUrl=r;let i=new Image;i.onload=()=>{e.img=i,U()},i.src=r}document.getElementById(`addTextBtn`)?.addEventListener(`click`,()=>{let e=document.getElementById(`textInput`).value.trim();if(!e)return;let t=g,n=document.createElement(`canvas`),r=n.getContext(`2d`);r.font=`bold ${s}px ${l}`,n.width=r.measureText(e).width+20,n.height=c,r.font=`bold ${s}px ${l}`,r.fillStyle=u,r.textBaseline=`middle`,r.fillText(e,10,70);let i=new Image;i.onload=()=>{let r=mt(t===`all`?p:t),a=n.width*.8,o=n.height*.8;v.push({type:`text`,srcUrl:n.toDataURL(),text:e,font:l,color:u,img:i,x:r.x-n.width/4,y:r.y-n.height/4,w:a,h:o,origW:a,origH:o,angle:0,pinned:!1,opacity:100,blend:`source-over`,part:t}),y=v.length-1,document.getElementById(`textInput`).value=``,U()},i.src=n.toDataURL()});var _t=document.getElementById(`textFont`),vt=document.getElementById(`textColorPicker`),yt=document.getElementById(`logoOpacity`),bt=document.getElementById(`logoBlend`);function xt(){let e=I.logoControls;if(!e)return;if(y<0){e.style.display=`none`,I.textOnlyControls&&(I.textOnlyControls.style.display=`none`);return}e.style.display=`block`;let t=v[y];yt&&(yt.value=t.opacity??100,I.logoOpacityVal&&(I.logoOpacityVal.textContent=`${yt.value}%`)),bt&&(bt.value=t.blend??`source-over`),I.textOnlyControls&&(I.textOnlyControls.style.display=t.type===`text`?`block`:`none`),t.type===`text`&&_t&&vt&&(_t.value=t.font,vt.value=t.color)}_t?.addEventListener(`change`,()=>{y>=0&&v[y].type===`text`&&(v[y].font=_t.value,gt(v[y]))}),vt?.addEventListener(`input`,()=>{y>=0&&v[y].type===`text`&&(v[y].color=vt.value,gt(v[y]))}),yt?.addEventListener(`input`,()=>{y<0||(v[y].opacity=Number(yt.value),U())}),bt?.addEventListener(`change`,()=>{if(y<0)return;let e=v[y];e.blend=bt.value;let t=w[e.part];t&&(e.blend===`multiply`?t.blending=4:e.blend===`screen`?t.blending=2:t.blending=1,t.needsUpdate=!0),U()});function St(){if(!ie)return;let e=document.querySelector(`.nav-item[data-section="upload"]`),t=document.querySelector(`.nav-item[data-section="text"]`),n=e&&e.classList.contains(`active`)||t&&t.classList.contains(`active`),r=I.uvMinimapContainer;if(!n){ie.classList.remove(`is-visible`),r&&r.classList.remove(`shift-left`);return}let i=e?.classList.contains(`active`),a=I.propertiesEmptyState,o=a?.querySelector(`p`);o&&(o.textContent=i?`Upload an image first`:`Add a text first`);let s=v.map((e,t)=>({logo:e,i:t})).filter(({logo:e})=>i?e.type!==`text`:e.type===`text`),c=s.length>0;a&&a.classList.toggle(`visible`,!c),ue&&(ue.closest(`.properties-section`).style.display=c?``:`none`);let l=document.querySelector(`.prop-grid`)?.closest(`.properties-section`);if(l&&(l.style.display=c?``:`none`),I.logoControls&&(I.logoControls.style.display=c&&y>=0?`block`:`none`),!c){ie.classList.add(`is-visible`),r&&r.classList.add(`shift-left`);return}ue.innerHTML=``;let u={};for(let{logo:e,i:t}of[...s].reverse())u[e.part]||(u[e.part]=[]),u[e.part].push(t);for(let[e,t]of Object.entries(u)){let n=document.createElement(`li`);n.className=`layer-group-header`,n.textContent=st(e),ue.appendChild(n);for(let e of t){let t=v[e],n=document.createElement(`li`);n.className=`layer-item ${e===y?`active`:``}`;let r=t.type===`text`;n.innerHTML=`
      ...
      `,n.addEventListener(`click`,()=>{y=e,v[e].part!==g&&ct(v[e].part),U()}),ue.appendChild(n)}}if(y>=0&&v[y]){let e=v[y];ae&&document.activeElement!==ae&&(ae.value=Math.round(e.w)),oe&&document.activeElement!==oe&&(oe.value=Math.round(e.h)),se&&document.activeElement!==se&&(se.value=Math.round(e.x)),ce&&document.activeElement!==ce&&(ce.value=Math.round(e.y)),F&&document.activeElement!==F&&(F.value=Math.round(e.angle*(180/Math.PI))),e.origW&&le&&document.activeElement!==le&&(le.value=Math.round(e.w/e.origW*100))}ie.classList.add(`is-visible`),r&&r.classList.add(`shift-left`)}window.toggleLayerLock=(e,t)=>{t.stopPropagation(),v[e].pinned=!v[e].pinned,U()},window.deleteLayer=(e,t)=>{t.stopPropagation(),O(v[e]),v.splice(e,1),y===e?y=-1:y>e&&y--,U()};var Ct=e=>{if(y<0)return;let t=v[y];if(t.x=parseFloat(se.value)||0,t.y=parseFloat(ce.value)||0,t.angle=(parseFloat(F.value)||0)*(Math.PI/180),e&&e.target===ae){let e=parseFloat(ae.value)||30,n=e/t.w;t.w=e,t.h*=n,le.value=Math.round(t.w/t.origW*100),oe.value=Math.round(t.h)}else if(e&&e.target===oe){let e=parseFloat(oe.value)||30,n=e/t.h;t.h=e,t.w*=n,le.value=Math.round(t.w/t.origW*100),ae.value=Math.round(t.w)}else{let e=(parseFloat(le.value)||100)/100;t.origW&&t.origH&&(t.w=t.origW*e,t.h=t.origH*e,ae.value=Math.round(t.w),oe.value=Math.round(t.h))}U()};[se,ce,F,le,ae,oe].forEach(e=>{e&&e.addEventListener(`input`,Ct)});var wt=document.getElementById(`uvMinimapContainer`),Tt=document.getElementById(`uvExpandBtn`),Et=document.getElementById(`uvMinimizeBtn`);Tt?.addEventListener(`click`,()=>{let e=wt.classList.toggle(`expanded`);at.width=e?1024:512,at.height=e?1024:512,Tt.innerHTML=e?`<svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14h6v6M20 10h-6V4M10 14l-7 7M14 10l7-7"/></svg>`:`<svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"><path d="M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7"/></svg>`,Xe()}),Et?.addEventListener(`click`,()=>{wt.classList.contains(`expanded`)&&Tt.click(),Et.innerHTML=wt.classList.toggle(`minimized`)?`<svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"><path d="M19 15l-7-7-7 7"/></svg>`:`<svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"><path d="M19 9l-7 7-7-7"/></svg>`,Xe()});var Dt=document.getElementById(`contextMenu`);function Ot(){Dt&&(Dt.style.display=`none`)}function kt(e,t){if(e.preventDefault(),!t){Ot();return}let n=-1;for(let e=v.length-1;e>=0;e--)if((t.part===`all`||v[e].part===t.part||v[e].part===`all`)&&Fe(v[e],t.x,t.y)){n=e;break}n>=0?(y=n,U(),Dt.style.display=`flex`,Dt.style.left=`${Math.min(e.clientX,window.innerWidth-Dt.offsetWidth-10)}px`,Dt.style.top=`${Math.min(e.clientY,window.innerHeight-Dt.offsetHeight-10)}px`):Ot()}L.addEventListener(`contextmenu`,e=>kt(e,et(e.clientX,e.clientY))),at&&at.addEventListener(`contextmenu`,e=>kt(e,tt(e.clientX,e.clientY))),window.addEventListener(`click`,Ot),document.getElementById(`ctxBringFront`)?.addEventListener(`click`,()=>{y<0||y===v.length-1||(v.push(v.splice(y,1)[0]),y=v.length-1,U())}),document.getElementById(`ctxBringForward`)?.addEventListener(`click`,()=>{if(y<0||y===v.length-1)return;let e=v[y];v[y]=v[y+1],v[y+1]=e,y++,U()}),document.getElementById(`ctxSendBackward`)?.addEventListener(`click`,()=>{if(y<=0)return;let e=v[y];v[y]=v[y-1],v[y-1]=e,y--,U()}),document.getElementById(`ctxSendBack`)?.addEventListener(`click`,()=>{y<=0||(v.unshift(v.splice(y,1)[0]),y=0,U())}),document.getElementById(`ctxLock`)?.addEventListener(`click`,()=>{y>=0&&(v[y].pinned=!v[y].pinned,U())}),document.getElementById(`ctxClone`)?.addEventListener(`click`,()=>{y>=0&&(v.push({...v[y],x:v[y].x+30,y:v[y].y+30}),y=v.length-1,U())}),document.getElementById(`ctxDelete`)?.addEventListener(`click`,()=>{y>=0&&!v[y].pinned&&(O(v[y]),v.splice(y,1),y=-1,U())});var At=JSON.parse(localStorage.getItem(`apparel_assets`))||[],jt=JSON.parse(localStorage.getItem(`apparel_configs`))||[];function Mt(){localStorage.setItem(`apparel_configs`,JSON.stringify(jt))}function Nt(){let e=I.assetGrid,t=document.getElementById(`modalAssetGrid`);I.assetCountLabel&&(I.assetCountLabel.textContent=`(${At.length}/${i})`),e&&(e.innerHTML=``),t&&(t.innerHTML=``),[...At].reverse().forEach((n,r)=>{let i=At.length-1-r,a=()=>{let e=document.createElement(`div`);return e.className=`asset-item`,e.innerHTML=`<img src="${n.url}" alt="Asset" /><div class="asset-delete-btn" title="Delete permanently">✕</div>`,e.querySelector(`img`).addEventListener(`click`,()=>{ht(n.url,g),document.getElementById(`assetModalOverlay`)?.classList.add(`hidden`)}),e.querySelector(`.asset-delete-btn`).addEventListener(`click`,e=>{e.stopPropagation(),At.splice(i,1),localStorage.setItem(`apparel_assets`,JSON.stringify(At)),Nt()}),e};e&&e.appendChild(a()),t&&t.appendChild(a())})}Nt();var Pt;function Ft(e){let t=document.getElementById(`toastNotification`),n=document.getElementById(`toastMessage`);!t||!n||(clearTimeout(Pt),n.textContent=e,t.classList.add(`show`),Pt=setTimeout(()=>{t.classList.remove(`show`)},2500))}var It=null;function Lt(e,t){let n=document.getElementById(`customConfirmOverlay`),r=document.getElementById(`customConfirmMessage`);n&&r&&(r.textContent=e,It=t,n.classList.remove(`hidden`))}document.getElementById(`customConfirmCancelBtn`)?.addEventListener(`click`,()=>{document.getElementById(`customConfirmOverlay`)?.classList.add(`hidden`),It=null}),document.getElementById(`customConfirmActionBtn`)?.addEventListener(`click`,()=>{document.getElementById(`customConfirmOverlay`)?.classList.add(`hidden`),It&&It(),It=null});var Rt=document.getElementById(`primaryUploadBtn`),zt=document.getElementById(`image-upload`);function Bt(e){if(At.length>=i){Ft(`Storage limit reached (${i} images maximum)`);return}let t=new FileReader;t.onload=e=>{let t=e.target.result;ht(t,g);try{At.push({url:t,part:g}),localStorage.setItem(`apparel_assets`,JSON.stringify(At)),Nt()}catch{Ft(`Browser storage full. Image applied but not saved.`)}},t.readAsDataURL(e)}Rt&&zt&&(Rt.addEventListener(`click`,()=>zt.click()),zt.addEventListener(`change`,e=>{e.target.files[0]&&Bt(e.target.files[0]),zt.value=``}));var Vt=document.getElementById(`viewAllAssetsBtn`),Ht=document.getElementById(`assetModalOverlay`),Ut=document.getElementById(`closeAssetModalBtn`),Gt=document.getElementById(`clearAllAssetsBtn`);Vt?.addEventListener(`click`,()=>Ht?.classList.remove(`hidden`)),Ut?.addEventListener(`click`,()=>Ht?.classList.add(`hidden`)),Ht?.addEventListener(`click`,e=>{e.target===Ht&&Ht.classList.add(`hidden`)}),Gt?.addEventListener(`click`,()=>{Lt(`Are you sure you want to delete all saved images? This cannot be undone.`,()=>{At=[],localStorage.removeItem(`apparel_assets`),Nt(),Ht?.classList.add(`hidden`)})});function Kt(){let e=document.getElementById(`savedDesignsGrid`);if(!e)return;e.innerHTML=``;let t=document.createElement(`div`);t.className=`saved-card saved-card--new`,t.innerHTML=`
  ...
  `,t.addEventListener(`click`,()=>{Lt(`Start a new design? Unsaved changes will be lost.`,()=>{Yt()})}),e.appendChild(t),[...jt].reverse().forEach(t=>{let n=jt.indexOf(t),r=document.createElement(`div`);r.className=`saved-card`;let i=new Date(t.id).toLocaleDateString(void 0,{month:`short`,day:`numeric`,year:`numeric`}),a=t.name||`Custom Design ${n+1}`,o=a.replace(/</g,`&lt;`).replace(/>/g,`&gt;`);r.innerHTML=`
    ...
    `,r.querySelector(`.asset-delete-btn`).addEventListener(`click`,e=>{e.stopPropagation(),jt.splice(n,1),Mt(),Kt()}),r.querySelector(`.saved-card-img-wrap`).addEventListener(`click`,()=>{Jt(t)});let s=r.querySelector(`.asset-edit-btn`),c=r.querySelector(`.saved-card-title`),l=e=>{e.stopPropagation();let n=document.createElement(`input`);n.type=`text`,n.value=a,n.className=`minimal-input`,n.style.padding=`2px 4px`,n.style.fontSize=`11px`,n.style.height=`20px`,n.style.marginBottom=`0`,n.addEventListener(`click`,e=>e.stopPropagation()),n.addEventListener(`dblclick`,e=>e.stopPropagation()),c.replaceWith(n),s.style.display=`none`,n.focus(),n.select(),n.addEventListener(`blur`,()=>{t.name=n.value.trim()||a,Mt(),Kt()}),n.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.preventDefault(),n.blur()),e.key===`Escape`&&Kt()})};s.addEventListener(`click`,l),c.addEventListener(`dblclick`,l),e.appendChild(r)})}Kt();function qt(){let e=document.getElementById(`btnSaveAsDefault`),t=document.getElementById(`btnSaveCurrent`),n=document.getElementById(`btnSaveNew`);h?(e&&(e.style.display=`none`),t&&(t.style.display=`inline-flex`),n&&(n.style.display=`inline-flex`)):(e&&(e.style.display=`inline-flex`),t&&(t.style.display=`none`),n&&(n.style.display=`none`))}function Jt(e){if(!e||!e.data)return;h=e.id,qt();let n=e.data,i=n.userConfiguration;i.partColors&&(Object.keys(i.partColors).forEach(e=>{f[e]={...i.partColors[e]}}),t.forEach(e=>{T[e]&&f[e]&&e!==`inside`&&T[e].color.set(f[e].color)}),Je=!0),n.scene?.backgroundColor&&_e(n.scene.backgroundColor),i.insideColor&&ve(`#${i.insideColor}`),be.position.copy(d[p]),R.target.set(0,0,0),R.update(),v.forEach(O),v.length=0,y=-1;let a=i.artworks||[],o=0;a.length===0?(U(),ct(p),lt(r[0]),Ft(`Design loaded successfully!`)):a.forEach(e=>{let t=new Image;t.onload=()=>{v.push({...e,img:t});let n=w[e.part];if(n&&e.blend&&(e.blend===`multiply`?n.blending=4:e.blend===`screen`?n.blending=2:n.blending=1,n.needsUpdate=!0),o++,o===a.length){let e=v.some(e=>e.type!==`text`),t=v.some(e=>e.type===`text`),n=e?`upload`:t?`text`:r[0];U(),ct(p),lt(n),Ft(`Design loaded successfully!`)}},t.onerror=()=>{if(o++,o===a.length){let e=v.some(e=>e.type!==`text`),t=v.some(e=>e.type===`text`),n=e?`upload`:t?`text`:r[0];U(),ct(p),lt(n),Ft(`Design loaded successfully!`)}},t.src=e.srcUrl})}function Yt(){h=null,qt(),t.forEach(t=>{if(t===`inside`)return;let n=e.model?.defaultColors?.[t]||`#FFFFFF`;f[t]={color:n,colorName:`Default`},t!==`all`&&T[t]&&T[t].color.set(n)}),v.forEach(O),v.length=0,y=-1,_e(m),ve(e.model.defaultColors.inside||`#FFFFFF`),ct(p),Je=!0,U(),lt(r[0]),Ft(`Started a new design`)}var Xt=document.getElementById(`savePromptOverlay`),Zt=document.getElementById(`saveDesignNameInput`);function Qt(){let e=1,t=`Custom Design ${e}`;for(;jt.some(e=>e.name===t);)e++,t=`Custom Design ${e}`;return t}var $t=()=>{Zt.value=``,Zt.placeholder=Qt(),Xt.classList.remove(`hidden`),Zt.focus()};document.getElementById(`btnSaveAsDefault`)?.addEventListener(`click`,$t),document.getElementById(`btnSaveNew`)?.addEventListener(`click`,$t),document.getElementById(`cancelSaveBtn`)?.addEventListener(`click`,()=>{Xt?.classList.add(`hidden`)}),document.getElementById(`confirmSaveBtn`)?.addEventListener(`click`,()=>{let e=Zt.value.trim()||Qt();Xt?.classList.add(`hidden`),en(e)}),document.getElementById(`btnSaveCurrent`)?.addEventListener(`click`,()=>{if(h){let e=jt.find(e=>e.id===h);if(!e){Ft(`Design no longer exists. Save as new instead.`),h=null,qt();return}en(e.name,h)}});function en(t,n=null){let r=v.map(e=>{let{img:t,...n}=e;return n}),i={...e,scene:{...e.scene,backgroundColor:e.scene.backgroundColor},userConfiguration:{activeView:g,partColors:JSON.parse(JSON.stringify(f)),artworks:r,insideColor:Te.color.getHexString()}},a=be.position.clone(),o=R.target.clone();be.position.copy(d[p]),R.target.set(0,0,0),R.update(),xe.render(de,be);let s=L.toDataURL(`image/jpeg`,.5);if(be.position.copy(a),R.target.copy(o),R.update(),n){let e=jt.findIndex(e=>e.id===n);e!==-1&&(jt[e].thumbnail=s,jt[e].data=i,Ft(`"${t}" updated!`))}else{let e=Date.now();jt.push({id:e,name:t,thumbnail:s,data:i}),h=e,qt(),Ft(`"${t}" saved to library!`)}Mt(),Kt()}(function(){let e=document.documentElement,t=document.getElementById(`themeToggle`),n=document.getElementById(`themeIcon`),r=`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><circle cx="12" cy="12" r="4"/><line x1="12" y1="2" x2="12" y2="5"/><line x1="12" y1="19" x2="12" y2="22"/><line x1="2" y1="12" x2="5" y2="12"/><line x1="19" y1="12" x2="22" y2="12"/><line x1="4.22" y1="4.22" x2="6.34" y2="6.34"/><line x1="17.66" y1="17.66" x2="19.78" y2="19.78"/><line x1="4.22" y1="19.78" x2="6.34" y2="17.66"/><line x1="17.66" y1="6.34" x2="19.78" y2="4.22"/></svg>`;e.classList.remove(`dark`),n&&(n.innerHTML=r),t&&t.addEventListener(`click`,()=>{let t=e.classList.toggle(`dark`);n&&(n.innerHTML=t?`<svg viewBox="0 0 24 24" fill="currentColor"><path d="M21 12.79A9 9 0 1 1 11.21 3a7 7 0 0 0 9.79 9.79z"/></svg>`:r)})})();var tn=document.getElementById(`loader`),nn=document.getElementById(`loaderBar`),rn=document.getElementById(`loaderLabel`),an=[`Preparing your canvas`,`Weaving the fabric`,`Calibrating materials`,`Almost ready…`],on=0,sn=setInterval(()=>{on=Math.min(on+1,an.length-1),nn&&(nn.style.width=`${on/(an.length-1)*85}%`),rn&&(rn.textContent=an[on])},600);function cn(){clearInterval(sn),nn&&(nn.style.width=`100%`),setTimeout(()=>{tn&&tn.classList.add(`hidden`),setTimeout(()=>tn?.remove(),700)},300)}var ln=new Xd;R.addEventListener(`change`,z);var q=()=>{ln.update(),R.autoRotateSpeed=8*ln.getDelta()*60,R.autoRotate?(R.update(),z()):R.update(),window.requestAnimationFrame(q)};function un(){ct(p);let t=e.userConfiguration?.artworks||[];if(t.length>0){let e=0;t.forEach(n=>{let i=new Image;i.onload=()=>{if(v.push({...n,img:i}),e++,e===t.length){v.forEach(e=>{let t=w[e.part];t&&e.blend&&(e.blend===`multiply`?t.blending=4:e.blend===`screen`?t.blending=2:t.blending=1,t.needsUpdate=!0)});let e=v.some(e=>e.type!==`text`),t=v.some(e=>e.type===`text`),n=e?`upload`:t?`text`:r[0];U(),lt(n)}},i.src=n.srcUrl})}else lt(r[0])}un(),q()}))();
//# sourceMappingURL=index-BapDdMS0.js.map